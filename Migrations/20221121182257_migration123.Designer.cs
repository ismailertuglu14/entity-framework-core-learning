...
namespace ders9.Migrations
{
    ...
    [Migration("20221121182257_migration123")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calisan", b =>
                {
                    ...
                    b.Property<int>("CalisanAdresiId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("CalisanAdresiId");
            ...
            modelBuilder.Entity("Calisan", b =>
                {
                    b.HasOne("CalisanAdresi", "CalisanAdresi")
                        .WithMany()
                        .HasForeignKey("CalisanAdresiId")
